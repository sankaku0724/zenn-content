...
:::message
しかし、**最新のUnix系システムではアクセス時刻の更新がデフォルトで無効化されている**ことがあります。
その場合、-aオプションを使用してもアクセス時刻は更新されず、-aオプションを指定せずにtouchコマンドを使用することで、最終更新時刻のみが更新される可能性があります。
:::
...
-cをオプションに指定している場合、**ファイルが存在しない場合にファイルを作成する**ことができます。
